...
\hypersetup{
  pdfauthor={Richard C. Lupton and Robin S. Langley},
  pdftitle={Improved linearised models of wind turbine aerodynamics and control
...
\def\ps@pprintTitle{%
 \let\@oddhead\@empty
 \let\@evenhead\@empty
 \def\@oddfoot{\footnotesize\itshape © 2018. This manuscript version is made
   available under the
